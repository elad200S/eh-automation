...
const articles = [
  {
    ...
    category: 'אוטומציה',
    excerpt: 'אוטומציה עסקית חוסכת 30–60% מזמן העבודה היומי ומביאה ROI של פי 6–10 — בלי לגייס עובדים נוספים. המדריך המלא: מה לאטמט, כמה עולה (₪300–2,500/חודש) ואיך מתחילים נכון.',
