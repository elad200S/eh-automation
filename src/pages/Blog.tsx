...
const articles = [
  {
    ...
    category: 'סוכני AI',
    excerpt: '28% מהעסקים בישראל כבר משתמשים ב-AI, אך 90% מהעסקים הקטנים עדיין לא. מדריך מעשי: מה זה סוכן AI, כמה עולה (₪3,500–12,000 הקמה), מה הוא עושה ומתי שווה להשקיע — עם נתונים ממקורות.',
