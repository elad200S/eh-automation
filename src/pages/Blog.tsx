...
const articles = [
  {
    ...
    category: 'אוטומציה',
    excerpt: 'אוטומציה עסקית מאפשרת לעסקים ישראלים לחסוך 35% בעלויות תפעול ולהגדיל המרות ב-40–60%. מדריך מעשי: אילו תהליכים לאטמט ראשונים, כמה עולה (₪1,490–₪9,000), ומה ה-ROI הריאלי.',
