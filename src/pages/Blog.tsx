...
const articles = [
  {
    ...
    category: 'סוכני AI',
    excerpt: 'סוכן AI מגיב ללידים ב-30 שניות במקום 42 שעות, פותר 78% מהפניות בלי מגע אנושי, ועולה שבר ממחיר עובד. כל מה שצריך לדעת לפני שמתחילים — מחירים, ROI ריאלי ו-5 טעויות נפוצות.',
