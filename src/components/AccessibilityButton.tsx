  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-0 top-[80%] -translate-y-1/2 scale-[0.85] origin-left z-[9999] w-14 h-14 rounded-r-full bg-primary text-primary-foreground shadow-lg flex items-center justify-center pr-1 hover:bg-primary/90 hover:shadow-xl transition-all focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
