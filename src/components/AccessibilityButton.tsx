  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-0 top-[68%] -translate-y-1/2 scale-[0.85] origin-left z-[9999] w-14 h-14 rounded-r-full bg-primary text-primary-foreground shadow-lg flex items-center justify-center pr-1 hover:bg-primary/90 hover:shadow-xl transition-all focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
      ...
      {isOpen && (
        <>
          ...
          {/* Menu Panel */}
          <div 
            className="fixed left-14 top-[68%] -translate-y-1/2 z-[9999] w-80 bg-card border border-border rounded-2xl shadow-2xl overflow-hidden animate-fade-up"
            dir="rtl"
          >
            {/* Header */}
