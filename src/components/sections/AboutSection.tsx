...
const highlights = [
  'עובד עם עסקים קטנים וסטארטאפים שרוצים לגדול בלי להוסיף עומס תפעולי',
  'מתמקד בתהליכים שחוזרים על עצמם – שם נמצא הערך האמיתי',
  'בונה פתרונות פשוטים שעובדים, לא מערכות מסובכות שדורשות תחזוקה',
  'מלווה את התהליך מאיפיון ועד הטמעה – לא נעלם באמצע',
];
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              אני אלעד חנינא, ואני עוזר לעסקים לבנות תשתית שעובדת בלי תלות באנשים. 
              הגישה שלי פשוטה: להבין מה באמת קורה בעסק, ולבנות מערכת שמייעלת את זה.
            </p>
